...
CREATE TABLE `alugarlivro` (
  ...
  KEY `turma_id_idx` (`turma_id`),
  CONSTRAINT `id_aluno` FOREIGN KEY (`id_aluno`) REFERENCES `tb_jmf_discente` (`id_aluno`),
  CONSTRAINT `id_colecao` FOREIGN KEY (`colecao_id`) REFERENCES `livrocolecao` (`id_colecao`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `turma_id` FOREIGN KEY (`turma_id`) REFERENCES `tb_jmf_turma` (`turma_id`)
...
INSERT INTO `alugarlivro` VALUES (15,'2023-09-09',2,'2023-09-09',108,2),(16,'2023-09-09',2,'2023-09-09',108,2),(17,'2023-09-01',2,'2023-09-09',108,2),(18,'2023-01-01',2,'2023-10-01',108,2),(19,'2023-05-15',3,'2023-06-22',108,1);
...
INSERT INTO `livro` VALUES (73,'jennilira','2022-09-23','ind','vnmvbnvn','1','2','2');
...
INSERT INTO `livrocolecao` VALUES (108,73,'disponível'),(109,73,'disponível');
...
-- Dump completed on 2023-06-22  9:21:41
